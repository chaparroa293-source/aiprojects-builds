...
Appointment, Contact, Payment, Follow-up, and Note remain candidate concepts only. Appointment is explicitly deferred; Session is not a scheduling or payment object.
